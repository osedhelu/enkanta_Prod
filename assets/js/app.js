...
function init() {
  ! function (t, e) {
    ...
    var k = "dropdown",
      ...
      j = function () {
        ...
        return i.toggle = function () {
          ...
          if (!(/input|textarea/i.test(n.target.tagName) ? 32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || e(n.target).closest(".dropdown-menu1").length) : !A.test(n.which)) && !this.disabled && !e(this).hasClass("disabled")) {
            var i = t._getParentFromElement(this),
              o = e(i).hasClass("show");
            if (o || 27 !== n.which) {
              if (n.preventDefault(), n.stopPropagation(), !o || o && (27 === n.which || 32 === n.which)) return 27 === n.which && e(i.querySelector('[data-toggle="dropdown"]')).trigger("focus"), void e(this).trigger("click");
              var s = [].slice.call(i.querySelectorAll(".dropdown-menu .dropdown-item1:not(.disabled):not(:disabled)")).filter((function (t) {
    ...
    e(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', j._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu1", j._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", j._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', (function (t) {
    ...
    var ot = "scrollspy",
      ...
      lt = function () {
        function t(t, n) {
          var i = this;
          this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(n), this._selector = this._config.target + " .nav-link," + this._config.target + " .list-group-item," + this._config.target + " .dropdown-item1", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, e(this._scrollElement).on("scroll.bs.scrollspy", (function (t) {
            return i._process(t)
        ...
        return n.refresh = function () {
          ...
          i.hasClass("dropdown-item1") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass("active"), i.addClass("active")) : (i.addClass("active"), i.parents(".nav, .list-group").prev(".nav-link, .list-group-item").addClass("active"), i.parents(".nav, .list-group").prev(".nav-item").children(".nav-link").addClass("active")), e(this._scrollElement).trigger("activate.bs.scrollspy", {
            relatedTarget: t
          })
        }, n._clear = function () {
        ...
        init: function () {
          ...
          function a() {
            var s = window.innerHeight,
              a = window.scrollY;
            i(".wow").each(function () {
              if ("visible" != i(this).css("visibility") && (s + a - 100 > n(this) && a < n(this) || s + a - 100 > n(this) + i(this).height() && a < n(this) + i(this).height() || s + a == i(document).height() && n(this) + 100 > i(document).height())) {
                var e = i(this).index(".wow"),
                  o = i(this).attr("data-wow-delay");
                if (o) {
                  o = i(this).attr("data-wow-delay").slice(0, -1);
                  var h = this;
                  parseFloat(o);
                  i(h).addClass("animated"), i(h).css({
                    visibility: "visible"
                  }), i(h).css({
                    "animation-delay": o
                  }), i(h).css({
                  ...
                  var d = 1e3 * i(this).css("animation-duration").slice(0, -1);
                  i(this).attr("data-wow-delay") && (d += 1e3 * i(this).attr("data-wow-delay").slice(0, -1));
                  h = this;
                  setTimeout(function () {
                    i(h).removeClass("animated")
                  }, d)
                } else {
                  i(this).addClass("animated"), i(this).css({
                    visibility: "visible"
                  }), i(this).css({
                    "animation-name": t[e]
                  });
                  d = 1e3 * i(this).css("animation-duration").slice(0, -1), h = this;
                  setTimeout(function () {
                    i(h).removeClass("animated")
                  }, d)
                }
          ...
          function n(i) {
            var t = i.getBoundingClientRect(),
              ...
              n = window.pageYOffset || a.scrollTop || s.scrollTop,
              e = a.clientTop || s.clientTop || 0,
              o = t.top + n - e;
            return Math.round(o)
          }
          i(".wow").each(function () {
            i(this).css({
              visibility: "hidden"
            }), t[i(this).index(".wow")] = i(this).css("animation-name"), i(this).css({
              "animation-name": "none"
            })
          }), i(window).scroll(function () {
            var t, e;
            s ? (t = window.innerHeight, e = window.scrollY, i(".wow.animated").each(function () {
              if (t + e - 100 > n(this) && e > n(this) + 100 || t + e - 100 < n(this) && e < n(this) + 100 || n(this) + i(this).height > i(document).height() - 100) i(this).removeClass("animated"), i(this).css({
                "animation-name": "none"
              }), i(this).css({
                visibility: "hidden"
              });
              else {
                var s = 1e3 * i(this).css("animation-duration").slice(0, -1);
                i(this).attr("data-wow-delay") && (s += 1e3 * i(this).attr("data-wow-delay").slice(0, -1));
                var a = this;
                setTimeout(function () {
                  i(a).removeClass("animated")
                }, s)
              }
            }), a(), s--) : a()
          }), i(".wow").each(function () {
            var s = i(this).index(".wow"),
              a = i(this).attr("data-wow-delay");
            a ? (a = i(this).attr("data-wow-delay").slice(0, -1), parseFloat(a), i(this).addClass("animated"), i(this).css({
              visibility: "visible"
            }), i(this).css({
              "animation-delay": a + "s"
            }), i(this).css({
      ...
      c = function () {
        function c(d, v) {
          _classCallCheck(this, c), this.defaults = {
            ...
            showOverlay: u,
            showCloseButton: h
          }, this.$element = d, this.$elementCloned = d.clone().css({
            display: "inline-block",
            lineHeight: "24px"
          }), this.options = this.assignOptions(v), this.menuOut = !1, this.lastTouchVelocity = {
            x: {
              startPosition: 0,
              startTime: 0,
              endPosition: 0,
          ...
          }, this.$body = t("body"), this.$menu = t("#".concat(this.$element.attr("data-activates"))), this.$sidenavOverlay = t("#sidenav-overlay"), this.$dragTarget = t(''), this.$body.append(this.$dragTarget), this.init()
        }
          ...
          value: function (t) {
            if ("touchend" === t.type) {
              ...
              var i = this.calculateTouchVelocityX(),
                n = e.clientX,
                s = n - this.options.MENU_WIDTH,
                o = n - this.options.MENU_WIDTH / 2;
              s > 0 && (s = 0), o < 0 && (o = 0), "left" === this.options.edge ? (this.menuOut && i <= .3 || i < -.5 ? (0 !== s && this.translateMenuX([0, s], "300"), this.showSidenavOverlay()) : (!this.menuOut || i > .3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.MENU_WIDTH - 10, s], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
                width: "10px",
                right: "",
                left: 0
          ...
          value: function (t) {
            if ("touch" === t.gesture.pointerType) {
              var e = t.gesture.velocityX,
                ...
                s = i - this.options.MENU_WIDTH / 2;
              n > 0 && (n = 0), s < 0 && (s = 0), "left" === this.options.edge ? (this.menuOut && e <= .3 || e < -.5 ? (0 !== n && this.translateMenuX([0, n], "300"), this.showSidenavOverlay()) : (!this.menuOut || e > .3) && (this.enableScrolling(), this.translateMenuX([-1 * this.options.MENU_WIDTH - 10, n], "200"), this.hideSidenavOverlay()), this.$dragTarget.css({
                width: "10px",
                right: "",
                left: 0
              })) : this.menuOut && e >= -.3 || e > .5 ? (this.translateMenuX([0, s], "300"), this.showSidenavOverlay(), this.$dragTarget.css({
                width: "50%",
                right: "",
                left: 0
              })) : (!this.menuOut || e < -.3) && (this.enableScrolling(), this.translateMenuX([this.options.MENU_WIDTH + 10, s], "200"), this.hideSidenavOverlay(), this.$dragTarget.css({
                width: "10px",
                right: 0,
                left: ""
              }))
  ...
  function _createClass(e, t, i) {
    ...
    var t, i = function () {
      function t(i, s) {
        _classCallCheck(this, t), this.$nativeSelect = i, this.defaults = {
          destroy: !1,
          nativeID: null,
          BSsearchIn: !1,
          BSinputText: !1,
      ...
      return _createClass(t, [{
        ...
        value: function () {
          ...
          if (this.$nativeSelect.before(this.$selectWrapper), this.appendDropdownIcon(), this.appendValidation(), this.appendMaterialSelect(), this.appendMaterialOptionsList(), this.appendNativeSelect(), this.appendSaveSelectButton(), this.$nativeSelect.is(":disabled") || this.$materialSelect.dropdown({
              hover: !1,
              closeOnClick: !1
            }), !1 !== this.$nativeSelect.data("inherit-tabindex") && this.$materialSelect.attr("tabindex", this.$nativeSelect.attr("tabindex")), this.isMultiple) this.$nativeSelect.find("option:selected:not(:disabled)").each(function (t, i) {
            var s = i.index;
            e._toggleSelectedValue(s), e.$materialOptionsList.find("li:not(.optgroup):not(.select-toggle-all)").eq(s).find(":checkbox").prop("checked", !0)
          });
          else {
            var t = this.$nativeSelect.find("option[selected]").first(),
              i = this.$nativeSelect.find("option").index(t.get(0));
            "disabled" !== t.attr("disabled") && i >= 0 && this._toggleSelectedValue(i)
          }
        ...
        value: function () {
          var t = this.$searchInput.find("input").val(),
            i = e('<option value="'.concat(t.toLowerCase(), '" selected>').concat(t, "</option>")).prop("selected", !0);
          this.isMultple || this.$nativeSelectChildren.each(function (t, i) {
            e(i).attr("selected", !1)
        ...
        value: function () {
          var t = this;
          this.$nativeSelectChildren.each(function (i, s) {
            var a = e(s);
            if (a.is("option")) t.buildSingleOption(a, t.isMultiple ? "multiple" : "");
            else if (a.is("optgroup")) {
              var l = e('<li class="optgroup"><span>'.concat(a.attr("label"), "</span></li>"));
              t.$materialOptionsList.append(l), a.children("option").each(function (i, s) {
                t.buildSingleOption(e(s), "optgroup-option")
              })
            }
          })
        }
        ...
        value: function (t, i) {
          var s = t.is(":disabled") ? "disabled" : "",
            a = "optgroup-option" === i ? "optgroup-option" : "",
            l = t.data("icon"),
            n = t.data("fas") ? '<i class="fa-pull-right m-2 fas fa-'.concat(t.data("fas"), " ").concat([...this.options.fasClasses].join(""), '"></i> ') : "",
            o = t.data("far") ? '<i class="fa-pull-right m-2 far fa-'.concat(t.data("far"), " ").concat([...this.options.farClasses].join(""), '"></i> ') : "",
            c = t.data("fab") ? '<i class="fa-pull-right m-2 fab fa-'.concat(t.data("fab"), " ").concat([...this.options.fabClasses].join(""), '"></i> ') : "",
            r = t.attr("class"),
            h = l ? '<img alt="" src="'.concat(l, '" class="').concat(r, '">') : "",
            p = this.isMultiple ? '<input type="checkbox" class="form-check-input" '.concat(s, "/><label></label>") : "";
          this.$materialOptionsList.append(e('<li class="'.concat(s, " ").concat(a, " ").concat(this.options.copyClassesOption ? r : "", ' ">').concat(h, '<span class="filtrable">').concat(p, " ").concat(t.html(), " ").concat(n, " ").concat(o, " ").concat(c, "</span></li>")))
        }
      }, {
        ...
        value: function () {
          var i = this,
            s = new MutationObserver(this._onMutationObserverChange.bind(this));
          s.observe(this.$nativeSelect.get(0), {
            attributes: !0,
            childList: !0,
            characterData: !0,
            subtree: !0
          }), s.customId = this.uuid, s.customStatus = "observing", t.clearMutationObservers(), t.mutationObservers.push(s), this.$nativeSelect.parent().find("button.btn-save").on("click", this._onSaveSelectBtnClick.bind(this)), this.$materialSelect.on("focus", this._onMaterialSelectFocus.bind(this)), this.$materialSelect.on("click", this._onMaterialSelectClick.bind(this)), this.$materialSelect.on("blur", this._onMaterialSelectBlur.bind(this)), this.$materialSelect.on("keydown", this._onMaterialSelectKeydown.bind(this)), this.$toggleAll.on("click", this._onToggleAllClick.bind(this)), this.$materialOptionsList.on("mousedown", this._onEachMaterialOptionMousedown.bind(this)), this.$materialOptionsList.find("li:not(.optgroup)").not(this.$toggleAll).each(function (t, s) {
            e(s).on("click", i._onEachMaterialOptionClick.bind(i, t, s))
        ...
        value: function (i) {
          i.forEach(function (i) {
            var s = e(i.target).closest("select");
            !0 !== s.data("stop-refresh") && ("childList" === i.type || "attributes" === i.type && e(i.target).is("option")) && (t.clearMutationObservers(), s.materialSelect({
              destroy: !0
            }), s.materialSelect())
          })
        }
        ...
        value: function (t, i, s) {
          ...
          if (!a.hasClass("disabled") && !a.hasClass("optgroup")) {
            ...
            if (this.isMultiple) {
              ...
              var n = Boolean(this.$nativeSelect.find("optgroup").length),
                o = this._isToggleAllPresent() ? a.index() - 1 : a.index();
              l = this.isSearchable && n ? this._toggleSelectedValue(o - a.prevAll(".optgroup").length - 1) : this.isSearchable ? this._toggleSelectedValue(o - 1) : n ? this._toggleSelectedValue(o - a.prevAll(".optgroup").length) : this._toggleSelectedValue(o), this._isToggleAllPresent() && this._updateToggleAllOption(), this.$materialSelect.trigger("focus")
        ...
        value: function () {
          var t = this;
          this.$materialOptionsList.find("li").each(function (i, s) {
            e(s).removeClass(t.keyboardActiveClass)
          })
        }
      }, {
        ...
        value: function (t) {
          ...
          this.isMultiple || this.mainLabel.addClass("active"), e(document).find("input.select-dropdown").each(function (t, i) {
            return e(i).val().length <= 0
          }).parent().next(".mdb-main-label").filter(function (t, i) {
            return e(i).prev().find("input.select-dropdown").val().length <= 0 && !e(i).prev().find("input.select-dropdown").hasClass("active")
          }).removeClass("active")
        }
      }, {
        ...
        value: function (t) {
          var i = this,
            s = e(this.$toggleAll).find('input[type="checkbox"]').first(),
            a = !e(s).prop("checked");
          e(s).prop("checked", a), this.$materialOptionsList.find("li:not(.optgroup):not(.select-toggle-all)").each(function (t, s) {
            var l = e(s).find('input[type="checkbox"]');
            a && l.is(":checked") || !a && !l.is(":checked") || e(s).is(":hidden") || e(s).is(".disabled") || (l.prop("checked", a), i.$nativeSelect.find("option").eq(t).prop("selected", a), a ? e(s).removeClass("active") : e(s).addClass("active"), i._toggleSelectedValue(t), i._selectOption(s), i._setValueToMaterialSelect())
        ...
        value: function (t) {
          var i = e(t.target),
            s = t.which === this.keyCodes.tab,
            a = t.which === this.keyCodes.esc,
            l = t.which === this.keyCodes.enter,
            n = l && t.shiftKey,
            o = t.which === this.keyCodes.arrowUp,
            c = t.which === this.keyCodes.arrowDown,
            r = this.$materialOptionsList.is(":visible");
          s ? this._handleTabKey(i) : !c || r ? l && !r || (t.preventDefault(), n ? this._handleEnterWithShiftKey(i) : l ? this._handleEnterKey(i) : c ? this._handleArrowDownKey() : o ? this._handleArrowUpKey() : a ? this._handleEscKey(i) : this._handleLetterKey(t)) : i.trigger("open")
        }
      }, {
        key: "_handleTabKey",
        value: function (e) {
        ...
        value: function () {
          var t = this,
            ...
            s = this.$materialOptionsList.find("li:visible").not(".disabled, .select-toggle-all").first(),
            a = this.$materialOptionsList.find("li:visible").not(".disabled, .select-toggle-all").last(),
            l = this.$materialOptionsList.find("li.selected").length > 0,
            n = l ? this.$materialOptionsList.find("li.selected").first() : s,
            o = n.next("li:visible:not(.disabled, .select-toggle-all)"),
            c = o;
          i.each(function (s, a) {
            e(a).hasClass(t.keyboardActiveClass) && (o = i.eq(s + 1), c = i.eq(s))
          });
          var r = n.is(a) || !l ? n : o;
          this._selectSingleOption(r), this._escapeKeyboardActiveOptions(), r.find("input").is(":checked") || r.removeClass(this.keyboardActiveClass), c.hasClass("selected") || c.find("input").is(":checked") || !this.isMultiple || c.removeClass("active", this.keyboardActiveClass), r.addClass(this.keyboardActiveClass), r.position() && this.$materialOptionsList.scrollTop(this.$materialOptionsList.scrollTop() + r.position().top)
        }
      }, {
        ...
        value: function () {
          var t = this,
            ...
            a = this.$materialOptionsList.find("li:visible").not(".disabled, .select-toggle-all").last(),
            l = this.$materialOptionsList.find("li.selected").length > 0,
            n = l ? this.$materialOptionsList.find("li.selected").first() : a,
            o = n.prev("li:visible:not(.disabled, .select-toggle-all)"),
            c = o;
          i.each(function (s, a) {
            e(a).hasClass(t.keyboardActiveClass) && (o = i.eq(s - 1), c = i.eq(s))
          });
        ...
        value: function (t) {
          ...
          if (this._escapeKeyboardActiveOptions(), this.isSearchable) {
            var s = t.which > 46 && t.which < 91,
              a = t.which > 93 && t.which < 106,
              l = 8 === t.which;
            (s || a) && this.$searchInput.find("input").val(t.key).focus(), l && this.$searchInput.find("input").val("").focus()
          } else {
            var n = "",
              o = String.fromCharCode(t.which).toLowerCase(),
              c = Object.keys(this.keyCodes).map(function (e) {
                return i.keyCodes[e]
              });
            if (o && -1 === c.indexOf(t.which)) {
              n += o;
              var r = this.$materialOptionsList.find("li").filter(function (t, i) {
                return e(i).text().toLowerCase().includes(n)
              }).first();
        ...
        value: function (t) {
          var i = e(t.target),
            ...
            n = l && t.shiftKey,
            o = t.which === this.keyCodes.arrowUp;
          if (t.which === this.keyCodes.arrowDown || s || a || o) return this.$materialSelect.focus(), void this._handleArrowDownKey();
          var c = i.closest("ul"),
            r = i.val(),
            h = c.find("li span.filtrable"),
            p = !1;
          if (h.each(function () {
              var t = e(this);
              if ("string" == typeof this.outerHTML) {
                var i = this.textContent.toLowerCase();
                i.includes(r.toLowerCase()) ? t.show().parent().show() : t.hide().parent().hide(), i.trim() === r.toLowerCase() && (p = !0)
              }
            }), l) return this.isEditable && !p ? void this.addNewOption() : (n && this._handleEnterWithShiftKey(i), void this.$materialSelect.trigger("open"));
          r && this.isEditable && !p ? this.$addOptionBtn.show() : this.$addOptionBtn.hide(), this._updateToggleAllOption()
        }
      }, {
...
function initXzoom() {
  console.log('init_function_zoom')
